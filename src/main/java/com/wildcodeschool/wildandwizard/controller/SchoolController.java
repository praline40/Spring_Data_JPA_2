...
public class SchoolController {
    ...
    public String inscription(Model out, @RequestParam Long idSchool) {
        ...
        // Au cas où cette école n'existe pas
        if (optionalSchool.isPresent()) {
            school = optionalSchool.get();
        }

        /***** on retrouvera ces attributs dans la classe html retournée (ici register)****/
        ...
        // getWizards située dans School.java
        Method method = getMethod(school, "getWizards", new Class[]{});
        if (method != null) {
            try {
                // on récupère tous les sorciers de cette école
